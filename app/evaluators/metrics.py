...
# Context relevance, to check if the retrieved context documents are relevant to the question, it measures the retrieval quality independent of generation quality.
